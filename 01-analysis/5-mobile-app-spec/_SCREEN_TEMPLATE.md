...
|--------|-----------------|----------|
| [LOGIC-XXX {Название}](../09_Логики/LOGIC-XXX_{Name}.md) | {Кнопка / Элемент} | {Краткое описание логики} |
...
**Логика:**
- {Элемент}: [LOGIC-XXX](../09_Логики/LOGIC-XXX_{Name}.md) — {краткое описание логики}
