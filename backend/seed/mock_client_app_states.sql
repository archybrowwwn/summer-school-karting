...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'Короткая трасса', 'novice', 8, 90, '[[59.978,30.262],[59.981,30.271],[59.976,30.285]]'),
    ('22222222-2222-2222-2222-222222222222', 'Длинная трасса', 'experienced', 12, 120, '[[59.942,30.226],[59.951,30.214],[59.963,30.232]]'),
...
generated_slots AS (
    SELECT
        ...
        END AS rental_price,
        CASE slot_idx
            WHEN 1 THEN 'Павильон у стартовой прямой'
            WHEN 2 THEN 'Бокс на длинной трассе'
